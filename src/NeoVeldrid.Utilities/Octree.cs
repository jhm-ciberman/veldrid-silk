...
namespace NeoVeldrid.Utilities
{
    ...
    public class Octree<T>
    {
        ...
        public void MoveItem(T item, BoundingBox newBounds)
        {
            ...
            if (!_currentRoot.TryGetContainedOctreeItem(item, out octreeItem))
            {
                throw new NeoVeldridException(item + " is not contained in the octree. It cannot be moved.");
            }
            else
            {
        ...
        public void MoveItem(OctreeItem<T> octreeItem, BoundingBox newBounds)
        {
            ...
            {
                throw new NeoVeldridException("Invalid bounds: " + newBounds);
            }
    ...
    public class OctreeNode<T>
    {
        ...
        public OctreeNode<T> AddItem(ref BoundingBox itemBounds, T item, out OctreeItem<T> octreeItem)
        {
            if (Parent != null)
            {
                throw new NeoVeldridException("Can only add items to the root Octree node.");
            }
        ...
        public OctreeNode<T> MoveContainedItem(OctreeItem<T> item, BoundingBox newBounds)
        {
            ...
            {
                throw new NeoVeldridException("Can't move item " + item + ", its container does not contain it.");
            }
        ...
        public void MarkItemAsMoved(OctreeItem<T> octreeItem, BoundingBox newBounds)
        {
            ...
            {
                throw new NeoVeldridException("Cannot mark item as moved which doesn't belong to this OctreeNode.");
            }
            if (newBounds.ContainsNaN())
            {
                throw new NeoVeldridException("Invalid bounds: " + newBounds);
        ...
        public void RemoveItem(OctreeItem<T> octreeItem)
        {
            ...
            {
                throw new NeoVeldridException("Item isn't contained in its container.");
            }
        ...
        public void Clear()
        {
            if (Parent != null)
            {
                throw new NeoVeldridException("Can only clear the root OctreeNode.");
            }
